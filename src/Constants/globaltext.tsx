export const BODY_TEXT = {
	bodyTitle: 'Soluciones informáticas a tu alcance',
	bodySubTitle: `Mejorá tu entorno`,
	bodySubTitle2: `Utilizá la tecnología a tu favor`,
}

export const CARD_BOX_TEXT = {
	MOBILE_APPS: "Aplicaciones Móbiles",
	MANAGE_DATA: "Gestión de Datos",
	ROBOTIZATION: "Asistencia con robotización",
